...
public class CenarioWebDriver {
	...
	public void exercicioLocalizarElemento() {
		...
		WebElement linkVoltar = driver.findElement(By
				.linkText("Voltar para a lista de exercícios"));
	}
	...
	public void testeFrame() {
		...
		driver.findElement(By.linkText("Página Verde"));
	}
	...
	public void testeFrameHard() {
		...
		driver.findElement(By.linkText("Página branca")).click();
		driver.switchTo().defaultContent();
		driver.switchTo().frame("content");
		Assert.assertEquals("Página branca",
				driver.findElement(By.tagName("h1")).getText());
		driver.findElement(By.linkText("Voltar para a página origial")).click();
